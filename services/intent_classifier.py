...
# Reference phrases for each category — expand these over time
# based on real queries that get misclassified.
CATEGORY_REFERENCES = {
    "greeting": [
...
# Precompute embeddings once at module load — not per-query
